...
# 申請システム関連設定
APPLICATION_CHANNEL_ID = 1387259707743277177  # 申請ボタンを維持するチャンネル
APPLICATION_CATEGORY_ID = 1134345613585170542  # 申請チャンネルを作成するカテゴリ
APPLICATION_LOG_CHANNEL_ID = 1333036649075970058  # 申請完了後のトランスクリプト送信先
APPLICATION_STAFF_ROLE_ID = 1404665259112792095  # 申請管理権限を持つロール
