...
def generate_profile_card(info, output_path="profile_card.png"):
    ...
    draw.text((text_x, text_y+45), f"Class: {active_char_info}", font=font_main, fill=(60,40,30,255))

    draw.text((90, 615), f"First Join: {info.get('first_join', 'N/A')}", font=font_raids, fill=(60,40,30,255))
    draw.text((90, 690), f"Last Seen: {info.get('last_join', 'N/A')}", font=font_raids, fill=(60,40,30,255))
    ...
    draw.text((800, 1200), f"{fmt_num(info.get('world_events', 0))}", font=font_raids, fill=(60,40,30,255))
    ...
    draw.text((525, 1375), "Generated by", font=font_mini, fill=(60,40,30,255))
    draw.text((575, 1425), "Minister Chikuwa#5740", font=font_mini, fill=(60,40,30,255))
