...
def generate_profile_card(info, output_path="profile_card.png"):
    ...
    draw.text((text_x, text_y+75), f"Class: {active_char_info}", font=font_main, fill=(60,40,30,255))
    ...
    draw.text((550, 1375), "Generated by", font=font_mini, fill=(60,40,30,255))
    draw.text((600, 1400), "Minister Chikuwa#5740", font=font_mini, fill=(60,40,30,255))
