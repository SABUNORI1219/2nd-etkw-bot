...
def draw_decorative_frame(
    ...
    arc_nudge_outer_topleft_y: int = -20,
    arc_nudge_outer_topright_x: int = 3.75,
    arc_nudge_outer_topright_y: int = -20,
    arc_nudge_outer_bottomleft_x: int = -4,
    arc_nudge_outer_bottomleft_y: int = 20,
    arc_nudge_outer_bottomright_x: int = 3.75,
    arc_nudge_outer_bottomright_y: int = 20,
    arc_nudge_inner_topleft_x: int = -3,
    arc_nudge_inner_topleft_y: int = -20,
    arc_nudge_inner_topright_x: int = 3,
    arc_nudge_inner_topright_y: int = -20,
    arc_nudge_inner_bottomleft_x: int = -3,
    arc_nudge_inner_bottomleft_y: int = 20,
    arc_nudge_inner_bottomright_x: int = 3,
    arc_nudge_inner_bottomright_y: int = 20,
    # 個別corner_trim
    corner_trim_top: Optional[int] = -2.5,
    corner_trim_bottom: Optional[int] = -2.5,
