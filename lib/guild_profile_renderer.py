...
def draw_decorative_frame(
    ...
    line_inset_inner_left: Optional[int] = 2.5,
    line_inset_inner_right: Optional[int] = 2.5,
    # 個別調整用（アーチ位置）
    ...
    arc_nudge_inner_topleft_y: int = -22.5,
    arc_nudge_inner_topright_x: int = 1,
    arc_nudge_inner_topright_y: int = -22.5,
    arc_nudge_inner_bottomleft_x: int = -2,
    arc_nudge_inner_bottomleft_y: int = 22.5,
    arc_nudge_inner_bottomright_x: int = 1,
    arc_nudge_inner_bottomright_y: int = 22.5,
    # 個別corner_trim
