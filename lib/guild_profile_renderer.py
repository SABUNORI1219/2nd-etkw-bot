    ...
    for role in role_order:
        ...
        for i in range(0, len(group_members), 2):
            ...
            if resized1 and server1:
                ...
                # ワールド名も描画必要！
                draw.text((world_x1, y1), server1, font=font_rank, fill=SUBTITLE_COLOR, anchor="ls")
            else:
            ...
            if p2:
                ...
                if resized2 and server2:
                    ...
                    # 二列目ワールド名も描画
                    draw.text((world_x2, y2), server2, font=font_rank, fill=SUBTITLE_COLOR, anchor="ls")
                else:
